    ...
    <section className="flex flex-col gap-2 px-2 pb-2 pt-8 bg-[--white]" id="szolgaltatasok">
      <H2 classname={''}>Szolgáltatások</H2>
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-2 rounded-lg overflow-hidden">
          ...
          <SzolgaltatasInner image={'/tehergepkocsi.webp'} title={'Tehergépkocsi, kamion szerviz'} l1={'Motor javítás'} l2={'Fék javítás'} l3={'Kuplungozás'} l4={'Nagyszerviz'} l5={'Műszakira való felkészítés'} l6={'Felépítmény javítás'} tel={'06309398591'}/>
