...
import { TbHammer, TbShoppingCart, TbTool } from "react-icons/tb";
import Link from "next/link";

export default function Szolgaltatasok() {
  return (
    <section className="flex flex-col gap-2 px-2 pb-2 pt-8 bg-[--white]" id="szolgaltatasok">
      <H2 classname={'mt-4'}>Szolgáltatások</H2>
        ...
        <div className="flex lg:flex-row flex-col mb-16 lg:gap-16 gap-8 justify-center w-full m-auto bg-[--lightgrey] rounded-3xl lg:p-8 p-4">
