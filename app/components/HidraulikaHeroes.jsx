  ...
  return (
    <>
      <section className="bg-[--white]" id="hidraulikaheroes">
        <div className="flex flex-col gap-2 bg-[--yellow] mx-2 rounded-3xl lg:pt-20 pt-8 px-2">
        <section className="relative flex flex-col gap-4 px-4 pb-16 items-center justify-center overflow-hidden rounded-3xl">
        <H1 classname={"mt-4 z-30"}>Hidraulika Heroes</H1>
          <div className="container m-auto relative flex flex-col gap-8 items-center justify-center z-10">
            ...
            <div className="flex flex-col gap-4 lg:w-1/2 w-full">
              <H2 classname={"text-[--black] z-30 text-center"}>
        ...
        <section className="flex flex-col gap-4 p-8 container m-auto bg-[--yellowhover] rounded-3xl">
        ...
        <section className="flex flex-col gap-2 container m-auto">
          <div className="flex flex-col items-center gap-2 m-auto">
            ...
            <div className="flex flex-col mb-2 lg:gap-16 gap-8 justify-center w-full m-auto bg-[--green] rounded-3xl lg:p-8 p-4">
            <H2 classname={"w-fit self-center"}>Hívj hőst!</H2>
            <div className="flex lg:flex-row flex-col lg:gap-16 gap-8 justify-center">
              ...
              <div className="flex lg:flex-row flex-col lg:items-center gap-4">
                ...
                <div className="flex lg:flex-row flex-col lg:gap-4 gap-2">
                  <Link href='tel:06 30 939 8591'><H3 classname={'underline'}>+36 30 939 8591</H3></Link>
                  <Link href='tel:06 30 302 0181'><H3 classname={'underline'}>+36 30 302 0181</H3></Link>
                </div>
              </div>
              <div className="flex lg:flex-row flex-col lg:items-center gap-4">
                <div className="flex flex-nowrap gap-2 items-center">
                  <TbShoppingCart className="text-4xl p-1 bg-[--yellow] rounded-full"/>
                  <H3 classname={'font-extrabold'}>Üzlet:</H3>
                </div>
                <Link href='tel:06 70 616 6005'><H3 classname={'underline'}>+36 70 616 6005</H3></Link>
              </div>
              </div>
            </div>
